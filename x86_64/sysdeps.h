...
/*
 * EFI Handover Protocol (Linux boot protocol 2.12+, kernels >= 3.3).
 *
 * xloadflags is a UINT16 at raw boot_params offset 0x236.
 * In elilo's struct this falls inside pad_8[1..2] (pad_8 starts at 0x235).
 * handover_offset is a UINT32 at raw offset 0x264 = pad_9[11].
 *
 * Bit 3 of xloadflags (XLF_EFI_HANDOVER_64) indicates the kernel supports
 * the 64-bit EFI handover entry at kernel_load_address + handover_offset.
 */
#define XLF_EFI_HANDOVER_64    (1U << 3)
#define BP_XLOADFLAGS(bp)      (*(const UINT16 *)((const UINT8 *)(bp) + 0x236))
#define BP_HANDOVER_OFFSET(bp) ((bp)->s.pad_9[11])
